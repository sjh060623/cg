...
const date = new Date().getFullYear();
  ...
  return (
    <div>
      <footer class="text-gray-600 body-font bg-white dark:bg-stone-900">
        <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
          ...
          <p class="text-sm dark:text-white text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">
            © {date} Chunggang —
            <a
