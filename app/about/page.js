...
export default function About() {
  return (
    <div className="w-full bg-[#272d39] ">
      <section class="text-gray-600 body-font translate-y-40 mb-44">
        <div class="container px-5 py-24 mx-auto">
          <div class="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
            ...
            <p class="leading-relaxe text-white text-9xl">청강학원</p>
            <span class="inline-block h-1 w-10 rounded bg-indigo-500 mt-8 mb-6"></span>
            <h2 class="text-white">학생들을 생각합니다</h2>
            <p class="text-white">"스스로" 를 중시합니다</p>
          </div>
        </div>
      </section>
      ...
      <section className="text-gray-600 body-font relative">
        ...
        <div className="container px-5 py-24 mx-auto flex">
          <div className="lg:w-1/3 md:w-1/2 bg-[#272d39] rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
          ...
          <div class="flex flex-wrap -m-4">
            <div class="p-4 lg:w-1/3">
              <div class="h-full bg-gray-50 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                ...
                <h1
                  class="title-font sm:text-2xl text-xl font-bold text-gray-900 mb-3"
